...
.page-shell {
  ...
  grid-template-columns: minmax(0, 1fr) minmax(0, var(--ticket-width));
  gap: var(--shell-gap);
...
body.layout-feed .page-shell { grid-template-columns: 1fr; }
...
body.hide-ticket .page-shell { grid-template-columns: 1fr !important; }
