...
@media (min-width: 1101px) {
  body:not(.hide-ticket):not(.layout-feed) .ticket {
    ...
    flex: 0 0 var(--ticket-width) !important;
    width: var(--ticket-width) !important;
    max-width: min(var(--ticket-width), 100%) !important;
    z-index: 2 !important;
  ...
  body.layout-wide:not(.hide-ticket):not(.layout-feed) .ticket {
    flex-basis: calc(var(--ticket-width) + 40px) !important;
    width: calc(var(--ticket-width) + 40px) !important;
    max-width: calc(var(--ticket-width) + 40px) !important;
  }
  .ticket-backdrop,
  .fab {
